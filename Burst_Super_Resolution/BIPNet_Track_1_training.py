...
def load_data(image_dir, burst_size):
    ...
    train_dataset = SyntheticBurst(
        train_zurich_raw2rgb, burst_size=burst_size, crop_sz=384
    )
    ...
    test_dataset = SyntheticBurst(
        test_zurich_raw2rgb, burst_size=burst_size, crop_sz=384
    )
